...
router.use('/', wechat(config, wechat.text(function (message, req, res, next) {
	...
	if (message.Content == 'profile') {
		...
		res.reply("你好好呀" +', 你可以发送文字跟我聊天，发送照片让我打分。');
	}
	...
	if (message.MsgType == 'event' && message.Event == 'subscribe') {
		var blogStr   = "<a href=\"http://satanwoo.github.io\">1. 访问我的技术博客</a>";
		var githubStr = "<a href=\"https://github.com/SatanWoo\">2. 访问我的Github</a>";
		res.reply(blogStr + githubStr);
	}
	// message为事件内容
	// { ToUserName: 'gh_d3e07d51b513',
	// FromUserName: 'oPKu7jgOibOA-De4u8J2RuNKpZRw',
